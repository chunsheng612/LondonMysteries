...
class AudioController {
    constructor() {
        ...
        this.bgmFiles = {
            hub: 'audio/Detective Office Hub.mp3',
            shop: 'audio/Case File Selection.mp3',
            puzzle: 'audio/1A2B Puzzle Board.mp3',
            final: 'audio/Main Theme - London Mysteries.mp3'
        };
        this.ambienceFiles = {
            breath: null,
            metal: null,
    ...
    updateMuteButton() {
        ...
        if (label) {
            label.textContent = this.muted ? '背景音效 已關閉' : '背景音效 已開啟';
        }
    }
}
